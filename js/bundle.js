  ...
  function getDinamycInformation(selector) {
    ...
    input.addEventListener('input', () => {
      ...
      switch (input.getAttribute('id')) {
        case 'height':
          height = deleteNotDigits(input.value);
          break;
        case 'weight':
          weight = deleteNotDigits(input.value);
          break;
        case 'age':
          age = deleteNotDigits(input.value);
          break;
        default:
          break;
      };
...
/* harmony import */ var _calc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./calc */ "./js/modules/calc.js");
...
function slider({ container, slide, nextArrow, previousArrow, totalCounter, currentCounter, wrapper, field }) {
  ...
  next.addEventListener('click', () => {
    if (offset == (0,_calc__WEBPACK_IMPORTED_MODULE_1__.deleteNotDigits)(width) * (slides.length - 1)) {
      offset = 0;
    } else {
      offset += (0,_calc__WEBPACK_IMPORTED_MODULE_1__.deleteNotDigits)(width);
    }
  ...
  prev.addEventListener('click', () => {
    if (offset == 0) {
      offset = (0,_calc__WEBPACK_IMPORTED_MODULE_1__.deleteNotDigits)(width) * (slides.length - 1)
    } else {
      offset -= (0,_calc__WEBPACK_IMPORTED_MODULE_1__.deleteNotDigits)(width);
    }
  ...
  dots.forEach(dot => {
    dot.addEventListener('click', (e) => {
      ...
      slideIndex = slideTo;
      offset = (0,_calc__WEBPACK_IMPORTED_MODULE_1__.deleteNotDigits)(width) * (slideTo - 1)
...
window.addEventListener('DOMContentLoaded', () => {
   ...
   (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-05-20T00:00:00');
